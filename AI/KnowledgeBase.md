...
├── user-manual/           # Documentation (main manual)
...
- Output location: `user-manual/jsdoc/`
...
- Both JSDoc and the User Manual are generated from the `user-manual/` directory
- A standard `Makefile` orchestrates the documentation build process
- To build documentation, run `make` from the `user-manual/` directory
